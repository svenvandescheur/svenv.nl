...
$__System.register('9', ['5', '6', '8'], function (_export) {
    var _createClass, _classCallCheck, $, Analytics;
        ...
        execute: function () {
            ...
            Analytics = (function () {
                ...
                _createClass(Analytics, [{
                    key: 'isVisitor',
                    value: function isVisitor() {
                        this.checkNonVisitorParam();

                        if ($('body').data('dnt') === 'True') {
                            return false;
                        }
                    ...
                    key: 'checkNonVisitorParam',
                    value: function checkNonVisitorParam() {
...
$__System.register('1', ['5', '6', '8', '9'], function (_export) {
    var _createClass, _classCallCheck, $, Analytics, View, CategoryView, Navbar, PostView;
        ...
        execute: function () {
            ...
            CategoryView = (function () {
                ...
                function CategoryView() {
                    ...
                    this.setUpFetchPosts().fadeInArticles().setUpRedirectToArticle();
                ...
                _createClass(CategoryView, [{
                    key: 'setUpFetchPosts',
                    value: function setUpFetchPosts() {
                    ...
                    key: 'getFetchPostsTarget',
                    value: function getFetchPostsTarget() {
                    ...
                    key: 'setFetchPostsTarget',
                    value: function setFetchPostsTarget(url) {
                    ...
                    key: '_fetchPostsSuccess',
                    value: function _fetchPostsSuccess(data) {
                    ...
                    key: '_fetchPostsError',
                    value: function _fetchPostsError() {
                    ...
                    key: 'setUpRedirectToArticle',
                    value: function setUpRedirectToArticle() {
                        var self = this;
                    ...
                    key: 'redirectToArticle',
                    value: function redirectToArticle(article) {
                    ...
                    key: 'setArticles',
                    value: function setArticles(data) {
            ...
            _export('CategoryView', CategoryView);
            ...
            Navbar = (function () {
                ...
                function Navbar() {
                    ...
                    this.setUpSearchFocusIn().setUpSearchFocusOut().setUpSearchInput();
                    return this;
                }
                ...
                _createClass(Navbar, [{
                    key: 'setUpSearchFocusIn',
                    value: function setUpSearchFocusIn() {
                    ...
                    key: 'hideNavOnMobile',
                    value: function hideNavOnMobile() {
                    ...
                    key: 'setUpSearchFocusOut',
                    value: function setUpSearchFocusOut() {
                    ...
                    key: 'showNavOnMobile',
                    value: function showNavOnMobile() {
                        var nav = this.nav;
                    ...
                    key: 'setUpSearchInput',
                    value: function setUpSearchInput() {
                    ...
                    value: function showSearchResults(query, data) {
                        var categoryview = new CategoryView();
                        categoryview.setFetchPostsTarget(categoryview.api_url + 'search/posts/?format=html&query=' + query).setArticles(data);
            ...
            PostView = (function () {
                ...
                _createClass(PostView, [{
                    ...
                    key: '_parallaxHeader',
                    value: function _parallaxHeader() {
